...
// Supabase 설정
export const SUPABASE_URL = "https://jzawdjxtrzgnspqnjmzj.supabase.co";

export const SUPABASE_ANON_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp6YXdkanh0cnpnbnNwcW5qbXpqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjkyMDEwNTgsImV4cCI6MjA4NDc3NzA1OH0.DlJ0dDSmLIYaJ4ksEl_Swe0GV-n6U1dAwEP06R1zdj8";
